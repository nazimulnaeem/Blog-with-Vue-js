        ...
        <div class="row justify-content-around">
            <div class="col-md-10 ">
                <div class="card card-primary">
                    <div class="card-header"><h3>Add new post</h3></div>
                <form class="mt-3" role="form" @submit.prevent="addnewPost()" enctype="multipart/form-data">
